...
func (c *loginServiceClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*user.User, error) {
...
func (c *loginServiceClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*user.User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(user.User)
...
func (UnimplementedLoginServiceServer) Register(context.Context, *RegisterRequest) (*user.User, error) {
	return nil, status.Error(codes.Unimplemented, "method Register not implemented")
}
func (UnimplementedLoginServiceServer) Login(context.Context, *LoginRequest) (*user.User, error) {
...
var LoginService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "xyz.fire_step.v1.login.LoginService",
	...
	Metadata: "xyz/fire-step/v1/login/service.proto",
}
